 ...
 * @see https://github.com/tailwindlabs/tailwindcss/blob/next/packages/tailwindcss/src/compat/colors.ts
 *  and https://tailwindcss.com/docs/customizing-colors
 */

/* eslint-disable sort-keys -- Colors are easier to maintain in a logical order over alphabetical */
export default {
  inherit: 'inherit',
